...
<section>
	<article class="flex-row gap2 flex-same-size yt-two-videos-container">
	...
	<article>
        <p>
            A language, created by Robbie Cole, meant to be spoken by the Rabbids of Ubisoft’s Rabbids franchise.
        </p>
    </article>
</section>