...
<Stripe>The Languages of Agma Schwa</Stripe>
<section>
    <h3 class="text-left">Naturalistic Conlangs</h3>
    <ul>
        ...
        <li><a href="/languages/nashan"><strong>Nashan</strong></a> (coming soon), the official language of the Nashan Empire by 2000AR</li>
        <li><a href="/languages/pthm"><strong>Pthm</strong></a>, the literary language of the Fifgath by 1600AR</li>
    </ul>

    <h3 class="text-left">Cursed Conlangs, Jokelangs</h3>
    <ul>
    ...
    <ul>
        <li><a href="https://youtu.be/PoUqMjboZLs"><strong>Kantwo</strong></a>, by Kaentwo</li>
        <li><a href="https://youtu.be/tATcokhBvQo"><strong>Mondir</strong></a>, by Salum the Conlang</li>
    </ul>
</section>