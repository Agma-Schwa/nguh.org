...
<section>
    ...
    <p>These are the nightmarish abominations created by Nguh and Ætérnal over the years:
...
<section>
    ...
    <div class="tab-wrapper">
        <div class="tab">
            <button class="tab-button" id="button_scd_docs" onclick={() => OpenTab('scd_docs')}>
                Documentation
            </button>
        </div>
