...
<section>
    <img src="$lib/images/the_channel/album 1.png" alt="ŋə music" class="my-0 mx-auto max-sm:w-full md:float-right w-1/2 ml-4 mb-4">
    <p class='-mt-1.5'>
    ...
    <p>
        ...
        actually the <a href="https://www.youtube.com/watch?v=PhKiGPkU-lo"> Dene-Yeniseian Language Family
        Connection</a> video essay, though this would not be released for several months.
    </p>
    ...
    <p>
        The biggest project of 2021 was the <a href="https://www.youtube.com/watch?v=rKk-kmQlFbM">Conlang Community
        Iceberg</a>, released in May of that year. This was a massive collaboration with over a dozen Conlang content
    ...
    <p>
        The pace of video releases slowed in 2023 for the sake of increasing quality as the audience of the channel grew. In October of 2023,
        after the announcement of the Second Cursed Conlang Circus, the channel passed 10,000 subscribers, a milestone Nguh originally considered
        to be the 'endgame.' 
    </p>
...
<section>
    <img src="$lib/images/the_channel/thum.jpg" alt="Allophone Video Thumbnail" class="my-0 mx-auto md:float-left md:w-1/2 md:mr-2">
    <p class='-mt-1.5'>
    ...
    <p>
        After the release of the <a href="/languages/rabbid">Rabbid Language</a> showcase in the fall of 2020,
    ...
    <p>There are also occasional livestreams titled “nguhstreams,” which vary in content from Conlang Counseling to
        Minecraft to Hunger Games and much more.
    </p>

    <p>In late 2021, Nguh began two series of YouTube Shorts which were also posted to TikTok, those being “Conlanging
